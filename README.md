...
引擎這側也留了兩份給想動手改的人:做「遊玩中即時切美術」時那一整類因重建資源而懸空指標
的崩潰、怎麼讓 release 版自報 backtrace、headless 怎麼重現,整理在
**[live-reload 懸空指標與崩潰除錯經驗](docs/live-reload-and-crash-debugging.md)**;各平台 tileset
怎麼從原始位元組救回正確顏色,則在 **[多平台 tileset 解碼經驗](docs/tileset-decode-lessons.md)**。
